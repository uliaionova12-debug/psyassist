...
const audiences = [
  {
    ...
    body: "Когда супервизор раз в месяц, а сложный случай — прямо сейчас",
  },
  {
    icon: "🧩",
    title: "Сложные кейсы",
    body: "Нарциссические структуры, суицидальный риск, эротический контрперенос — требует точности",
  },
  {
    icon: "📋",
    title: "Супервизоры и тренеры",
    body: "Структурировать наблюдения перед групповой или индивидуальной работой",
  },
  {
    icon: "🔒",
    title: "Строгая конфиденциальность",
    body: "Имена клиентов не нужны. Данные не хранятся и не обучают модели",
  },
];
...
const steps = [
  {
    num: "01",
    title: "Опишите случай своими словами",
    body: "Без шаблонов и форм. PsyAssist задаёт уточняющие вопросы — как живой супервизор на первой встрече.",
  },
  {
    num: "02",
    title: "Идёте через клиническую логику",
    body: "Фокус, запрос, динамика поля, контрперенос. Система не даёт советов — помогает вам думать структурированно.",
  },
  {
    num: "03",
    title: "Получаете разбор на вашем кейсе",
    body: "Рабочие гипотезы, направления работы, интеграционная рефлексия — всё анкеровано на вашем конкретном случае.",
  },
];
...
const modules = [
  {
    ...
    scenario: "Есть клиент, который не выходит из головы.",
    description:
      "Структурированный клинический разбор: от нарратива до рабочей гипотезы. Как живая супервизия — но в любое время суток.",
    href: "/case",
  ...
  },
  {
    ...
    scenario: "Клиент написал странное сообщение.",
    description:
      "Анализ переписки, голосовых, скриншотов. Что за этим стоит: тест на доступность, тревога привязанности, манипуляция?",
    href: "/chat-analysis",
  ...
  },
  {
    ...
    scenario: "Чувствуете, что что-то изменилось в процессе.",
    description:
      "Картина изменений во времени: гипотезы, разрывы альянса, ремонт, тактические решения между встречами.",
    href: "/client",
    tone: "ghost" as const,
  },
];
...
const testimonials = [
  {
    quote:
      "Разбирала кейс с нарциссическим клиентом. Система сразу вышла на финансовый контрперенос — я о нём даже не думала. Вернулась к этому на следующей сессии.",
    name: "Анна К.",
    title: "Гештальт-терапевт, 9 лет практики",
  },
  {
    quote:
      "Работаю в частной практике, супервизор раз в месяц. PsyAssist стал пространством, где я думаю между встречами. Не даёт готовых ответов — и это правильно.",
    name: "Марина Р.",
    title: "Психоаналитический психотерапевт",
  },
  {
    quote:
      "Пришла с послеродовым кейсом. Система поставила safety before depth ещё на первом шаге — именно это я и хотела проверить у себя.",
    name: "Светлана В.",
    title: "КПТ-терапевт, перинатальная специализация",
  },
];
...
const pricingPlans = [
  {
    ...
    price: "Бесплатно",
    period: "",
    description: "Чтобы попробовать и убедиться",
    features: [
      "3 супервизии в месяц",
      "Все три модуля",
      "Полный клинический разбор",
      "Без кредитной карты",
    ],
  ...
  },
  {
    ...
    price: "600 ₽",
    period: "/ месяц",
    description: "Для постоянной клинической практики",
    features: [
      "Неограниченные супервизии",
      "Библиотека разобранных кейсов",
      "Экспорт гипотез и заметок",
      "Все обновления первым",
    ],
...
const faqs = [
  {
    q: "PsyAssist заменяет живую супервизию?",
    a: "Нет — и мы говорим об этом прямо. PsyAssist помогает думать структурированно между супервизиями, а не вместо них. Этические и клинические решения всегда остаются за вами.",
  },
  {
    q: "Данные о клиентах защищены?",
    a: "Вам не нужно вводить имена клиентов. Платформа работает с клиническими описаниями. Данные не передаются третьим лицам и не используются для обучения AI-моделей.",
  },
  {
    q: "Кто стоит за клинической логикой?",
    a: "PsyAssist создан практикующим клиническим психологом и аккредитованным супервизором. Вся логика основана на реальных клинических сценариях — не на шаблонах из учебников.",
  },
  {
    q: "Для какого модального подхода подходит?",
    a: "Для любого — гештальт, психоанализ, КПТ, системный, нарративный. Вы указываете свой метод при работе с кейсом, система адаптирует язык супервизии.",
  },
];
      ...
      <header className="sticky top-0 z-50 border-b border-[color:var(--border)] bg-[color:var(--bg)]/90 backdrop-blur-md">
        <Container className="flex items-center justify-between py-3 sm:py-3.5">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold tracking-[-0.02em] text-[color:var(--text)]">
              PsyAssist
            </span>
          </div>
          ...
          <ButtonLink href="/case" tone="primary" className="px-4 py-2 text-sm">
            Попробовать →
          </ButtonLink>
        </Container>
      </header>
      ...
      <main>
          ...
          <Container className="py-14 sm:py-20 md:py-24">
            <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-12 lg:gap-20">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <h1 className="mt-4 text-balance text-[1.75rem] font-semibold leading-[1.17] tracking-[-0.035em] text-[color:var(--text)] sm:text-4xl md:text-[2.5rem] lg:text-[2.875rem]">
                  Есть клиент, который не выходит у вас из головы?
                </h1>
                <p className="mt-3 text-xl font-medium tracking-[-0.02em] text-[color:var(--accent-sand)] sm:text-2xl">
                  Терапия идёт. Ясность — нет.
                </p>
                <p className="mx-auto mt-5 max-w-lg text-pretty text-base leading-relaxed text-[color:var(--muted)] sm:text-[17px] md:mx-0">
                ...
                <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center md:justify-start">
                  ...
                  <a
                    href="#how-it-works"
                    className="text-sm text-[color:var(--muted)] underline underline-offset-4 transition hover:text-[color:var(--text)]"
                  >
                    Смотреть как работает ↓
                  </a>
                </div>
                <div className="mt-7 flex flex-wrap justify-center gap-x-5 gap-y-2 text-xs text-[color:var(--muted)] md:justify-start">
                  <span>✓ Приватно</span>
              ...
              {/* — photo — */}
              <div className="relative w-full max-w-[300px] shrink-0 md:max-w-[360px] lg:max-w-[400px]">
          ...
          <Container className="py-6">
            <div className="flex flex-wrap items-center justify-center gap-8 text-center sm:gap-12 md:gap-16">
              {[
                ...
                <div key={label}>
                  <p className="text-xl font-semibold text-[color:var(--accent-sand)] sm:text-2xl">{val}</p>
        ...
        <section aria-label="Ситуации" className="py-16 sm:py-20 md:py-24">
          <Container>
            ...
            <p className="mx-auto mt-3 max-w-md text-center text-base text-[color:var(--muted)]">
              Именно для них и создан PsyAssist.
            </p>
            <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-3">
              {painPoints.map((p) => (
                <Card key={p.title} className="p-6 sm:p-7">
                  <div className="mb-4 text-3xl">{p.emoji}</div>
                  <h3 className="text-base font-semibold tracking-[-0.02em] text-[color:var(--text)]">
                    {p.title}
                  </h3>
        ...
        {/* ═══ FOR WHOM ═══ */}
        <section id="for-whom" aria-label="Для кого" className="bg-white py-16 sm:py-20 md:py-24">
          <Container>
            <p className="mb-2 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
              Для кого PsyAssist
            </p>
            <h2 className="text-center text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
        ...
        {/* ═══ QUOTE / CASE TEASER ═══ */}
        <section aria-label="Пример кейса" className="py-16 sm:py-20 md:py-24">
          <Container>
            <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-16">
              <div className="relative w-full max-w-[280px] shrink-0 md:max-w-[320px]">
                <div className="relative aspect-[3/4] overflow-hidden rounded-3xl shadow-xl">
                  <Image
                    src="/photos/yulia-busts.jpg"
                    alt="Клиническая психология — работа с глубиной"
                    fill
              ...
              <div className="flex-1">
                ...
                <ButtonLink href="/case" tone="primary" className="mt-6 px-5 py-2.5">
                  Попробовать разобрать кейс →
                </ButtonLink>
              </div>
            </div>
          </Container>
        ...
        {/* ═══ HOW IT WORKS ═══ */}
        <section id="how-it-works" aria-label="Как работает" className="bg-white py-16 sm:py-20 md:py-24">
          <Container>
            <p className="mb-2 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
              Как работает
            </p>
            <h2 className="text-center text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
              Как работает AI-супервизия
            </h2>
            <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
              {steps.map((s) => (
                <div key={s.num}>
                  <p className="text-[2.5rem] font-bold leading-none tracking-[-0.05em] text-[color:var(--accent-sand)]">
                    {s.num}
                  </p>
                  <h3 className="mt-4 text-base font-semibold tracking-[-0.02em] text-[color:var(--text)]">
                    {s.title}
                  </h3>
            ...
            <div className="mt-14 flex flex-wrap items-end justify-center gap-6">
              {[
                { src: "/screenshots/app-main.png", alt: "PsyAssist — меню супервизии", label: "Главное меню" },
                { src: "/screenshots/app-billing.png", alt: "PsyAssist — тарифы", label: "Баланс и тарифы" },
              ].map(({ src, alt, label }) => (
        ...
        {/* ═══ ABOUT CREATOR ═══ */}
        <section aria-label="Об авторе" className="py-16 sm:py-20 md:py-24">
          <Container>
            <div className="flex flex-col items-center gap-10 md:flex-row md:items-start md:gap-16">
              ...
              <div className="flex-1">
                <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
                  Создано специалистом
                </p>
                <h2 className="mt-3 text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
                  Не разработчиком. Психологом.
                </h2>
        ...
        {/* ═══ MODULES ═══ */}
        <section id="modules" aria-label="Модули" className="bg-white py-16 sm:py-20 md:py-24">
          <Container>
            <p className="mb-2 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
              Клинические модули
            </p>
            <h2 className="text-center text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
              Три инструмента для реальной практики
            </h2>
            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
              {modules.map((m) => (
                <Card key={m.title} className="flex flex-col p-6 sm:p-7">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[color:var(--muted)]">
                    {m.tag}
                  </p>
                  <h3 className="mt-3 text-lg font-semibold tracking-[-0.02em] text-[color:var(--text)]">
                    {m.title}
                  </h3>
                  <p className="mt-2 text-sm font-medium italic text-[color:var(--accent-sand)]">
                    {m.scenario}
                  </p>
                  <p className="mt-2 flex-1 text-sm leading-relaxed text-[color:var(--muted)]">
                    {m.description}
                  </p>
                  <ButtonLink href={m.href} tone={m.tone} className="mt-5 w-full text-center">
                    Открыть модуль
                  </ButtonLink>
                </Card>
              ))}
        ...
        {/* ═══ TESTIMONIALS ═══ */}
        <section aria-label="Отзывы" className="py-16 sm:py-20 md:py-24">
          <Container>
            <h2 className="text-center text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
              Что говорят коллеги
            </h2>
            <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
              {testimonials.map((t) => (
                <Card key={t.name} className="flex flex-col p-6 sm:p-7">
                  <p className="flex-1 text-sm leading-relaxed text-[color:var(--text)]">
                    «{t.quote}»
                  </p>
        ...
        {/* ═══ PRICING ═══ */}
        <section id="pricing" aria-label="Тарифы" className="bg-white py-16 sm:py-20 md:py-24">
          <Container>
            <p className="mb-2 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[color:var(--muted)]">
              Тарифы
            </p>
            ...
            <p className="mx-auto mt-3 max-w-sm text-center text-base text-[color:var(--muted)]">
              Попробуйте с реальным кейсом — без карты и без обязательств.
            </p>
                ...
                >
                  <p
                    className={`text-[10px] font-semibold uppercase tracking-[0.14em] ${
                      plan.primary ? "text-white/60" : "text-[color:var(--muted)]"
                    }`}
                  >
                    {plan.name}
                  </p>
                  <div className="mt-3 flex items-baseline gap-1">
                    <span
                      className={`text-3xl font-semibold tracking-[-0.03em] ${
                        plan.primary ? "text-white" : "text-[color:var(--text)]"
                      }`}
                    >
                      {plan.price}
                    </span>
                    {plan.period && (
                      <span className={`text-sm ${plan.primary ? "text-white/60" : "text-[color:var(--muted)]"}`}>
                        {plan.period}
                      </span>
                    )}
                  </div>
                  <p className={`mt-1 text-sm ${plan.primary ? "text-white/70" : "text-[color:var(--muted)]"}`}>
                    {plan.description}
                  </p>
                    ...
                    {plan.features.map((f) => (
                      <li
                        ...
                        className={`flex items-start gap-2 text-sm ${
                          plan.primary ? "text-white/90" : "text-[color:var(--muted)]"
                        }`}
                      >
                        <span className={`mt-[2px] shrink-0 ${plan.primary ? "text-white" : "text-[color:var(--accent-sand)]"}`}>
                          ✓
                        </span>
                        {f}
                      </li>
                  ...
                  <div className="mt-6">
                    <ButtonLink
                      href={plan.href}
                      tone={plan.primary ? "ghost" : "primary"}
        ...
        {/* ═══ FAQ ═══ */}
        <section aria-label="Частые вопросы" className="py-16 sm:py-20 md:py-24">
          <Container>
            <h2 className="text-center text-2xl font-semibold tracking-[-0.03em] text-[color:var(--text)] sm:text-[1.875rem]">
              Частые вопросы
            </h2>
        ...
        <section
          ...
          className="overflow-hidden bg-[color:var(--accent-green)] py-16 sm:py-20"
        >
          <Container>
            <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-16">
              <div className="relative w-full max-w-[240px] shrink-0 md:max-w-[280px]">
                <div className="relative aspect-[3/4] overflow-hidden rounded-3xl shadow-2xl">
                  <Image
                    src="/photos/yulia-laptop.jpg"
                    alt="PsyAssist — разбираем случай вместе"
                    fill
                    className="object-cover"
        ...
        {/* ═══ ETHICS ═══ */}
        <section aria-label="Этика и приватность" className="py-10 sm:py-12">
          <Container>
